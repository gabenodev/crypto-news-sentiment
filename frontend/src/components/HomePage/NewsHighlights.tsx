...
const NewsHighlights = () => {
  ...
  if (error || news.length === 0) {
    ...
    const fallbackNews = [
      ...
      {
        title: "Regulatory Developments: New Crypto Frameworks Emerging Globally",
        description:
  ...
  return (
    <div className="bg-white/95 dark:bg-dark-secondary/95 rounded-2xl shadow-xl border border-gray-200/60 dark:border-gray-700/60 p-5 h-full">
      <div className="flex justify-between items-center mb-4 pb-3 border-b border-gray-200/50 dark:border-gray-700/50">
        <h3 className="text-xl font-bold">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-green-500">Latest News</span>
        </h3>
        <a
          href="/news"
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-2 mb-1">{article.description}</p>
