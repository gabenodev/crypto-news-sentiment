    ...
    <div className="bg-white/95 dark:bg-dark-secondary/95 rounded-2xl shadow-xl border border-gray-200/60 dark:border-gray-700/60 p-5 h-full">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm font-medium mt-1" style={{ color: sentimentColor }}>
            {sentimentLabel}
          </span>

          <div className="w-full mt-4">
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">7-Day Trend</h4>
            ...
            <div className="flex justify-between mt-1">
              <span className="text-xs text-gray-500 dark:text-gray-400">7 days ago</span>
          ...
          <div className="grid grid-cols-2 gap-2 w-full mt-4">
            <div className="flex items-center text-xs">
              ...
              <span className="text-gray-600 dark:text-gray-400">Extreme Fear (0-25)</span>
            </div>
            <div className="flex items-center text-xs">
              <div className="w-3 h-3 rounded-full bg-amber-500 mr-1"></div>
              <span className="text-gray-600 dark:text-gray-400">Fear (26-45)</span>
            </div>
            <div className="flex items-center text-xs">
              <div className="w-3 h-3 rounded-full bg-yellow-400 mr-1"></div>
              <span className="text-gray-600 dark:text-gray-400">Neutral (46-55)</span>
            </div>
            <div className="flex items-center text-xs">
              <div className="w-3 h-3 rounded-full bg-emerald-500 mr-1"></div>
              <span className="text-gray-600 dark:text-gray-400">Greed (56-100)</span>
            </div>
          </div>
        </div>
      )}
