...
import type { WalletTransactionHistoryProps, TransactionData } from "./types";
...
const WalletTransactionHistory: React.FC<WalletTransactionHistoryProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      setLocalError(err.message || "Error processing data");
    } finally {
      setLoading(false);
  ...
  // Format native token value with the correct symbol
