...
function NewsCard(): JSX.Element {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-md p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">No Crypto News Found</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-primary p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-2">Crypto News</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">Stay updated with the latest cryptocurrency news</p>
          ...
          <div className="w-full md:w-48">
            <div className="relative">
              <select
                ...
                value={sortOption}
                onChange={(e) => setSortOption(e.target.value as "relevance" | "date")}
              >
          ...
          {sortedNews.map((article, index) => (
            ...
            >
              <div className="relative h-48 w-full overflow-hidden">
                <img
                  src={article.urlToImage || `https://picsum.photos/600/400?random=${index}`}
                  alt={article.title}
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-dark-text-secondary mb-4 line-clamp-3">{article.description}</p>
