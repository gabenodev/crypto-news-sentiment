    ...
    <div className="p-6">
      <div className="flex justify-center mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Loading whale transactions...</span>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {Array(5)
          .fill(0)
          .map((_, i) => (
            <div key={i} className="border rounded-lg p-4 animate-pulse bg-gray-50 dark:bg-gray-800">
