...
import { FiSearch, FiStar, FiInfo, FiArrowRight, FiPieChart, FiActivity } from "react-icons/fi"
    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Explore any Ethereum wallet and analyze asset distribution in real-time
        </p>
      </motion.div>
        ...
        <div className="lg:col-span-2">
          ...
          >
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors ${
                    isLoading || !address.trim() ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                >
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    Enter a valid Ethereum address to see all ERC-20 tokens held by that wallet.
                  </p>
                  <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                    <strong>Note:</strong> Due to API limitations, some tokens or values may not display correctly. For
                    a complete view, please verify on{" "}
                    <a
            ...
            {recentWallets.length > 0 && (
              <div className="mb-6">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Recent Wallets</h3>
                <div className="flex flex-wrap gap-2">
                  {recentWallets.map((wallet) => (
                    <div key={wallet} className="flex items-center">
                      <div className="w-6 h-6 rounded-full overflow-hidden mr-2">
                        <img
                          src={generateWalletPlaceholder(wallet, 24) || "/placeholder.svg"}
                          alt="Wallet"
              ...
              >
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full overflow-hidden mr-3">
                    <img
                      src={generateWalletPlaceholder(wallet.address, 40) || "/placeholder.svg"}
                      alt={wallet.name}
                      className="w-full h-full object-cover"
                    />
                  </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Enter an Ethereum address to see all wallet details, including held assets, transactions, and analytics.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                Enter an Ethereum address or choose a popular wallet to get started.
              </p>
            </div>
            ...
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                See all tokens held, their value, and portfolio distribution. Some tokens may be filtered due to API
                limitations.
              </p>
            </div>
